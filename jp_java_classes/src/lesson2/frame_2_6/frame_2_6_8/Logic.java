...
// to do mistake due to move getHorVerdirection
	...
	public void putTankToRndAttackerPos() {
		...
		int [][] attackerPos = new int [3][];
		attackerPos[0]= new int[]{0,0};
		attackerPos[1]= new int[]{0,8};
		attackerPos[2]= new int[]{0,4};
		...
		int y = attackerPos[rndPos-1][0];
		int x = attackerPos[rndPos-1][1];
	...
	public void putTankToRndDefenderPos() {
		...
		int [][] attackerPos = new int [3][];
		attackerPos[0]= new int[]{8,0};
		attackerPos[1]= new int[]{8,8};
		attackerPos[2]= new int[]{8,4};
