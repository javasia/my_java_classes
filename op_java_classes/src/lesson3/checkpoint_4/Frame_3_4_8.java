 ...
 * @version 3.1
 */
public class Frame_3_4_8 extends JPanel {
	...
	void runTheGame() throws Exception {
		...
		turnTank(directionLeft);
		Thread.sleep(500);
		System.out.println("Shooting...\n");
		fire();

		System.out.println("Turning...\n");
		turnTank(directionRight);
		Thread.sleep(500);
		System.out.println("Shooting...\n");
		fire();

		System.out.println("Turning...\n");
		turnTank(directionUp);
		Thread.sleep(500);
		System.out.println("Shooting...\n");
		fire();

		System.out.println("Turning...\n");
		turnTank(directionDown);
		Thread.sleep(500);
		System.out.println("Shooting...\n");
		fire();
	...
	public static void main(String[] args) throws Exception {
		Frame_3_4_8 bf = new Frame_3_4_8();
		bf.runTheGame();
	}

	public Frame_3_4_8() throws Exception {
