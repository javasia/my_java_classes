 ...
 * @version 3.1
 */
public class Frame_3_4_10 extends JPanel {
	...
	void runTheGame() throws Exception {
		...
		System.out.println(getQuadrant(0, 50));
		System.out.println(getQuadrant(512, 512));
		System.out.println(getQuadrant(256, 260));
		System.out.println(getQuadrant(256, 128));
	...
	public static void main(String[] args) throws Exception {
		Frame_3_4_10 bf = new Frame_3_4_10();
		bf.runTheGame();
	}

	public Frame_3_4_10() throws Exception {
