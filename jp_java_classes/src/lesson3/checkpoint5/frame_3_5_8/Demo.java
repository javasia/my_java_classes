...
public class Demo {
	...
	static Ingredient[] ingredients = new Ingredient[8];
	static Product[] products = new Product[8];
	...
	private static void createProducts() {
		...
		for (Product p : products) {
			p = new Product(productList[i], ingredients, createRecipe(productList[i]));
			products[i]=p;
			i++;
		}
	}

	private static String[] returnProductList() {
	...
	private static int[] createRecipe(String name) {
