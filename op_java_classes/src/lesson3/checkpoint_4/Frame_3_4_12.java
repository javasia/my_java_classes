 ...
 * @version 3.1
 */
public class Frame_3_4_12 extends JPanel {
	...
	boolean processInterception() throws InterruptedException {
		...
		int devider = coordinates.indexOf("_");
		int quadY = Integer.parseInt(coordinates.substring(0, devider));
		int quadX = Integer.parseInt(coordinates.substring(devider + 1));
	...
	String getQuadrant(int x, int y) {
		int quadSize = 64;
		String res = String.valueOf(y / quadSize) + "_" + String.valueOf(x / quadSize);
		return res;
	}
	...
	boolean isTank(int y, int x){
		int quadSize =64;
		int quadX=tankX/quadSize;
		int quadY=tankY/quadSize;
		if (quadX==x && quadY ==y) {
		return true;
		}
		return false;
	...
	public static void main(String[] args) throws Exception {
		Frame_3_4_12 bf = new Frame_3_4_12();
		bf.runTheGame();
	}

	public Frame_3_4_12() throws Exception {
